        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestLastActivityID = table.Column<int>(type: "int", nullable: true),
                    RequestUnitID = table.Column<int>(type: "int", nullable: true),
                    ...
                    RequestFileUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RequestFileName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<bool>(type: "bit", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Requests_Activities_RequestLastActivityID",
                        column: x => x.RequestLastActivityID,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Requests_Units_RequestUnitID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedUserID = table.Column<int>(type: "int", nullable: true),
                    RequestActivityUserID = table.Column<int>(type: "int", nullable: true),
                    NewActivityStatusID = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequestActivities", x => x.RequestActivityID);
                    table.ForeignKey(
                        name: "FK_RequestActivities_Activities_ActivityStatusID",
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.NewActivityStatusID,
                        principalTable: "Activities",
                        principalColumn: "ActivityID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RequestActivities_AspNetUsers_AssignedUserID",
                        column: x => x.AssignedUserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RequestActivities_AspNetUsers_RequestActivityUserID",
                        column: x => x.RequestActivityUserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequestActivities_ActivityStatusID",
                table: "RequestActivities",
                column: "ActivityStatusID");

            migrationBuilder.CreateIndex(
                name: "IX_RequestActivities_AssignedUserID",
                table: "RequestActivities",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequestActivities_RequestActivityUserID",
                table: "RequestActivities",
                column: "RequestActivityUserID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Requests_RequestLastActivityID",
                table: "Requests",
                column: "RequestLastActivityID");
